...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    {
        UIAlertView* view = [[UIAlertView alloc] initWithTitle:@"请至少连接四个点！" message:nil delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [view show];
    }
